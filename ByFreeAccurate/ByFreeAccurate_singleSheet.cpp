/*=========================================================
 * ByFreeAccurate_singleSheet.c - A mex routine that calculates the
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
 ...
 "MATLAB:gammaf length does not match source length!");
    ...
    ByFreeAccurate_singleSheet_routine(nt, ztreal, ztimag, ns, zetaf_r, zetaf_i, potreal, potimag, L, gammaf);
}
